...
class PatientServiceTest {
        ...
        void setUp() {
                ...
                patientService = new PatientService(mockPatientRepository, mockUtilService, mockDataValidationService,
                                mockEncryptionService, mockHealthDataService);
                ...
                testPatientListDecrypted = new ArrayList<>() {
                        {
                                add(new Patient("2", "Erika", "Musterfrau", "1986-05-04", "Female",
                                                ...
                                                new ContactInformation("0153476539", "test@email.com", "Sesamstraße 56",
                                                                "68593 Teststadt"),
                                                "123456789101"));
                        }
                };
        ...
        void getPatientById_returnsPatient_withGivenId() throws InvalidIdException {
                when(mockPatientRepository.findById("2"))
                                .thenReturn(Optional.ofNullable(testPatientListEncrypted.getFirst()));
        ...
        void createPatient_returnsPatient_whenPatientIsCreated() {
                PatientPersonalDTO newPatientDto = new PatientPersonalDTO(
                                testPatientListDecrypted.getFirst().firstname(),
                                testPatientListDecrypted.getFirst().lastname(),
                                testPatientListDecrypted.getFirst().dateOfBirth(),
                                testPatientListDecrypted.getFirst().gender(),
                                testPatientListDecrypted.getFirst().emergencyContact(),
                                testPatientListDecrypted.getFirst().nationality(),
                                testPatientListDecrypted.getFirst().maritalStatus(),
                                testPatientListDecrypted.getFirst().primaryLanguage(),
                                testPatientListDecrypted.getFirst().occupation(),
                                testPatientListDecrypted.getFirst().insuranceNr(),
                                testPatientListDecrypted.getFirst().contactInformation());

                HealthData expectedHealthData = new HealthData("123456789101", newPatientDto.gender(), 38,
                                LocalDate.now(), new ArrayList<>());

                when(mockUtilService.generateId()).thenReturn("newId");
                when(mockHealthDataService.createHealthData(any(HealthDataDto.class))).thenReturn(expectedHealthData);
                when(mockPatientRepository.save(any(Patient.class)))
                                .thenAnswer(invocation -> invocation.getArgument(0));

                Patient result = patientService.createPatient(newPatientDto);

                // Assertions
                assertNotNull(result); // Ensure result is not null
                assertEquals("Erika", result.firstname());
                assertEquals("Musterfrau", result.lastname());
                assertEquals("123456789101", result.healthDataId()); // Assuming healthDataId is set correctly
                verify(mockPatientRepository).save(any(Patient.class));
                verify(mockHealthDataService).createHealthData(any(HealthDataDto.class));
        }
        ...
        void createPatient_shouldThrowException_WhenWentWrong() {
                ...
                HealthDataDto newHealthDataDto = new HealthDataDto(newPatient.gender(), 38, LocalDate.now(),
                                medicalExaminations);
                HealthData newHealthData = new HealthData("123456789101", newPatient.gender(), 38, LocalDate.now(),
                                medicalExaminations);
        ...
        void updatePatient_returnsPatient_whenPatientIsUpdated() throws InvalidIdException {
                ...
                List<IcdCode> icdCodes = List.of(new IcdCode("ICD-10", "Description of ICD-10"));
                LocalDateTime examinationDate = LocalDateTime.of(2024, 1, 1, 0, 0);
                MedicalExamination updatedExamination = new MedicalExamination(examinationDate, icdCodes, "Symptoms",
                                "Diagnosis",
                                List.of("Medication1", "Medication2"),
                                List.of(new Treatment("Treatment1", "Description of Treatment1")),
                                List.of(new VitalSigns(37.5, 120, 80, 60, 15)), "Additional Notes");
                List<MedicalExamination> medicalExaminations = new ArrayList<>();
                medicalExaminations.add(updatedExamination);
                HealthData updatedHealthData = new HealthData("123456789101", updateDto.gender(), 38, LocalDate.now(),
                                medicalExaminations);
                ...
                when(mockHealthDataService.addExaminationWithIcdCodes(anyString(), any(MedicalExamination.class)))
                                .thenReturn(updatedHealthData);
        ...
        void updatePatient_throwsException_whenPatientNotFound() {
                ...
                assertThrows(InvalidIdException.class, () -> patientService.updatePatientById("2",
                                new PatientPersonalDTO("Erika", "Musterfrau", "1986-05-04", "Female",
                                                new EmergencyContact("Harald Musterfrau", "Husband", "01785469875"),
                                                "German", "Married", "German", "Engineer", "12335467",
                                                new ContactInformation("0153476539", "test@email.com", "Sesamstraße 56",
                                                                "68593 Teststadt"))));
        ...
        void createOrUpdatePatient_createsNewPatient_whenExistingPatientIsNull() {
                ...
                when(mockHealthDataService.createHealthData(newHealthData)).thenReturn(new HealthData("123456789101",
                                newHealthData.gender(), newHealthData.ageAtFirstAdmission(),
        ...
        void createEncryptedContactInformation_createsEncryptedContactInformation() {
                ContactInformation contact = new ContactInformation("0153476539", "test@email.com", "Sesamstraße 56",
                                "68593 Teststadt");
        ...
        void validatePatientData_invalidName_shouldThrowException() {
                PatientPersonalDTO invalidPatient = new PatientPersonalDTO("invalid name", "Musterfrau", "1986-05-04",
                                "Female",
                                new EmergencyContact("Harald Musterfrau", "Husband", "01785469875"),
                                "German", "Married", "German", "Engineer", "12335467",
                                new ContactInformation("0153476539", "test@email.com", "Sesamstraße 56",
        ...
        void validatePatientData_invalidInsuranceNumber_shouldThrowException() {
                PatientPersonalDTO invalidPatient = new PatientPersonalDTO("Erika", "Musterfrau", "1986-05-04",
                                "Female",
                                new EmergencyContact("Harald Musterfrau", "Husband", "01785469875"),
        ...
        void validatePatientData_invalidDateOfBirth_shouldThrowException() {
                PatientPersonalDTO invalidPatient = new PatientPersonalDTO("Erika", "Musterfrau", "invalid-date",
                                "Female",
                                new EmergencyContact("Harald Musterfrau", "Husband", "01785469875"),
                                "German", "Married", "German", "Engineer", "12335467",
                                new ContactInformation("0153476539", "test@email.com", "Sesamstraße 56",
        ...
        void validatePatientData_invalidPhoneNumber_shouldThrowException() {
                PatientPersonalDTO invalidPatient = new PatientPersonalDTO("Erika", "Musterfrau", "1986-05-04",
                                ...
                                new EmergencyContact("Harald Musterfrau", "Husband", "01785469875"),
                                "German", "Married", "German", "Engineer", "12335467",
                                new ContactInformation("invalid-phone", "test@email.com", "Sesamstraße 56",
                                                "68593 Teststadt"));
        ...
        void validatePatientData_invalidEmail_shouldThrowException() {
                PatientPersonalDTO invalidPatient = new PatientPersonalDTO("Erika", "Musterfrau", "1986-05-04",
                                ...
                                new EmergencyContact("Harald Musterfrau", "Husband", "01785469875"),
                                "German", "Married", "German", "Engineer", "12335467",
                                new ContactInformation("0153476539", "invalid-email", "Sesamstraße 56",
                                                "68593 Teststadt"));
        ...
        void validatePatientData_invalidEmergencyContact_shouldThrowException() {
                EmergencyContact invalidEmergencyContact = new EmergencyContact("Harald Musterfrau", "Husband",
                                "InvalidContact");
                PatientPersonalDTO invalidPatient = new PatientPersonalDTO("Erika", "Musterfrau", "1986-05-04",
                                "Female",
